...
// Stub out `require2` in the browser
//
    ...
    less.Parser = function Parser(env) {
        ...
        function getDebugInfo(index, inputStream, env) {
            ...
            if(less.mode !== 'browser' && less.mode !== 'rhino') {
                filename = require2('path').resolve(filename);
            }
                ...
                root.toCSS = (function (evaluate) {
                    return function (options, variables) {
                        ...
                        if (options.cleancss && less.mode === 'node') {
                            return require2('clean-css').process(css);
    ...
    (function (tree) {
        ...
        tree.functions = {
            ...
            _minmax: function (isMin, args) {
                ...
                switch(args.length) {
                    case 0: throw { type: "Argument", message: "one or more arguments require2d" };
...
// these static methods are used as a fallback when the optional 'mime' dependency is missing
        tree._mime = {
            ...
            lookup: function (filepath) {
                var ext = require2('path').extname(filepath),
                    type = tree._mime._types[ext];
                if (type === undefined) {
                    throw new Error('Optional dependency "mime" is require2d for ' + ext);
                }
                return type;
            },
            charsets: {
...
//
    ...
    (function (tree) {
        ...
        tree.mixin.Definition = function (name, params, rules, condition, variadic) {
            ...
            this.rules = rules;
            this._lookups = {};
            this.require2d = params.reduce(function (count, p) {
        ...
        tree.mixin.Definition.prototype = {
            ...
            matchArgs: function (args, env) {
                ...
                if (! this.variadic) {
                    if (argsLength < this.require2d)                               { return false; }
                    if (argsLength > this.params.length)                          { return false; }
                } else {
                    if (argsLength < (this.require2d - 1))                         { return false; }
                }
    ...
    (function (tree) {
        ...
        tree.sourceMapOutput = function (options) {
            ...
            this._sourceMapGeneratorConstructor = options.sourceMapGenerator || require2("source-map").SourceMapGenerator;
